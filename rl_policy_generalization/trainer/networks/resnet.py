...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes, nf,
                    multi_head=False, n_classes_per_task=5):
...
def ResNet18(num_classes, nf=20, multi_head=True, n_classes_per_task=5): # nf=64 in original code, but nf=20 as default in David Lopez-Paz paper
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes, nf, 
                    multi_head, n_classes_per_task)
